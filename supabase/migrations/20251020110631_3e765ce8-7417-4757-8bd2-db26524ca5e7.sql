-- Add show_kyc_page column to website_settings
ALTER TABLE public.website_settings 
ADD COLUMN show_kyc_page BOOLEAN DEFAULT true;

COMMENT ON COLUMN public.website_settings.show_kyc_page IS 
'Control visibility of KYC page in user console. When disabled, KYC menu item is hidden from user navigation.';

-- Update the update_website_settings function to handle the new field
