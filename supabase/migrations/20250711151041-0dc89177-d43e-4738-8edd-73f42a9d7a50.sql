-- Update admin_create_transaction function to use proper reference formatting
...
BEGIN
  ...
  -- Generate reference number with proper prefix
  v_reference_prefix := 'CRE'; -- Both credit and debit use CRE as requested
